...
class MainActivity : AppCompatActivity(), LocationListener {
    ...
    private var currentLocation = Location(LocationManager.NETWORK_PROVIDER);
                ...
                when(msg.what){
                    ...
                    7->{
                        ...
                        try {
                            ...
                            binding.sensorView.setText("* SOS received from ground: ETA $duration mins *")
                            groundreply = true
                        } catch (e: JSONException) {}
                    }
                }
    ...
    inner class HelpMessage(var stopflag: Boolean = false):Thread(){
        ...
        fun setJSON():JSONObject {
            ...
            try{
                ...
                jsonarray.put("lat", currentLocation.latitude)
                jsonarray.put("lon", currentLocation.longitude)
